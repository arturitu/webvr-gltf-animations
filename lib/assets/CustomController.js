...
CustomController.prototype.addCustomController = function () {
  // circle = new THREE.Mesh( new THREE.CircleGeometry(circleRadius,6), new THREE.MeshBasicMaterial({
    circle = new THREE.Mesh( new THREE.PlaneGeometry(circleRadius*2,circleRadius*2), new THREE.MeshBasicMaterial({
    transparent: true,
    opacity: 1,
    map: new THREE.TextureLoader().load( "images/controller-emojis.png" ),
