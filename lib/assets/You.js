    ...
    if(this.app.rayInput.controller.gamepad.id !== idController){
      ...
      switch (idController) {
        ...
        case "Gear VR Controller":
          ...
          this.handR = new Hand(this.app, false, isLeftHanded);
          this.handL = new Hand(this.app, true, isLeftHanded);
          if(isLeftHanded){
            youContainer.add(this.handL);
          }else{
            youContainer.add(this.handR);
          }
          break;
      }
    }else{
