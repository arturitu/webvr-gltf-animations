...
const CustomController = require('./assets/CustomController');

const Expressions = require('./assets/Expressions');
...
function App () {
  function init () {
    ...
    desk.position.set(0,controls.userHeight-0.3,-0.8);
    scene.add(desk);
